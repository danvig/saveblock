        ...
        <div class="row property__gallery">
            <div class="col-lg-3 col-md-4 col-sm-6 mix women">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        <h6><a href="amongus.php">Among Us</a></h6>
                        <div class="rating">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix men">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        <h6><a href="undertale.php">Undertale</a></h6>
                        <div class="rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix accessories">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="img/shop/product_gameblock_minecraft.jpg">
                        <div class="label stockout">HOT</div>
                        <ul class="product__hover">
                    ...
                    <div class="product__item__text">
                        <h6><a href="minecraft.php">Minecraft</a></h6>
                        <div class="rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix cosmetic">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        <h6><a href="simpsons.php">Simpsons</a></h6>
                        <div class="rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
