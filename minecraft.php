...
<head>
    ...
    <title>Shop | MineCraft GameBlock</title>
            ...
            <div class="row">
                    ...
                    <div class="product__details__pic">
                        <div class="product__details__pic__left product__thumb nice-scroll">
                            <a class="pt active" href="#product-1">
                                <img src="img/shop/product_gameblock_minecraft.jpg" alt="">
                            </a>
                            <!--
                        ...
                        <div class="product__details__slider__content">
                            <div class="product__details__pic__slider owl-carousel">
                                <img data-hash="product-1" class="product__big__img" src="img/shop/product_gameblock_minecraft.jpg" alt="">
                                <!--
                ...
                <div class="col-lg-6">
                    <div class="product__details__text">
                        <h3>MineCraft GameBlock <span>Brand: SaveBlock</span></h3>
                        <div class="rating">
                        ...
                        <p>Yes Dream cheated that Speedrun and it doesn't matter. Dream does dig Saveblocks though, he couldn't 'save' his reputation.</p>
