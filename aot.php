            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__links">
                        ...
                        <span>Attack on Titan AniBlock</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                    ...
                    <div class="product__details__pic">
                        <div class="product__details__pic__left product__thumb nice-scroll">
                            <a class="pt active" href="#product-1">
                                <img src="img/shop/product_aniblock_aot.jpg" alt="">
                            </a>
                            <!--
                        ...
                        <div class="product__details__slider__content">
                            <div class="product__details__pic__slider owl-carousel">
                                <img data-hash="product-1" class="product__big__img" src="img/shop/product_aniblock_aot.jpg" alt="">
                                <!--
                ...
                <div class="col-lg-6">
                    <div class="product__details__text">
                        <h3>Attack on Titan AniBlock <span>Brand: SaveBlock</span></h3>
                        <div class="rating">
                        ...
                        <p>Attack on Titan is ending and you still torrent it? Well fix that Eren attitude of yours and share the greatness with this treasure.</p>
